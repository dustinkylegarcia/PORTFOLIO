...
export default function Hero() {
  return (
    <section className="h-screen flex flex-col justify-center items-center bg-gradient-to-r from-gray-900 via-blue-900 to-gray-900 text-white text-center px-6">
      <motion.h2
        className="font-serif text-5xl md:text-6xl font-extrabold mb-4"
      ...
      <motion.p
        className="font-sans text-xl md:text-2xl text-gray-300 max-w-xl"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ delay: 0.5, duration: 0.8 }}
      >
        I build modern websites and applications using the{" "}
        <span className="font-bold text-blue-300">MERN stack</span>.
      </motion.p>
